...
=======
dataAll = dataAll.head(10)
>>>>>>> bafab2b23206df69deea4ad7d83ef4ebbb3794e5
...
for i in range(2, max_number_of_clusters):    
    ...
    for idx, label in enumerate(matrix.labels_):
        print("idx:")
        print(idx)
        print("label:")
        print(label)
        
    #print(all_features.named_steps['union'])
    #print(all_features.named_steps['union'].transformer_list[0])
    #print(all_features.named_steps['union'].transformer_list[0][1])
    #print(all_features.named_steps['union'].transformer_list[0][1].named_steps['abstract_pl'])
    #print(all_features.named_steps['union'].transformer_list[0][1].named_steps['abstract_pl'].get_feature_names())
